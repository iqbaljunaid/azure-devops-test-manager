...
class TestCLI:
    ...
    def test_update_command_dry_run(self, mock_manager_class):
        ...
        with patch('sys.argv', ['azure-devops-test-manager', '12345', '--update-outcome', 'Passed', '--dry-run']):
            with patch('builtins.print') as mock_print:
                result = main()
    ...
    def test_xml_update_command(self, mock_manager_class):
        ...
        try:
            with patch('sys.argv', ['azure-devops-test-manager', '12345', '--from-xml', xml_path]):
                with patch('builtins.print') as mock_print:
                    result = main()
...
class TestArgumentParsing:
    ...
    def test_basic_arguments(self):
        ...
        with patch('azure_devops_test_manager.cli.AzureTestPointManager') as mock_manager_class:
            mock_manager = Mock()
            mock_manager.organization_url = 'https://test.visualstudio.com'
            mock_manager.project_name = 'Test Project'
            mock_manager_class.return_value = mock_manager
